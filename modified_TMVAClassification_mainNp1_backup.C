...
//       factory->AddSpectator("ll_mass", "", "", 'F' );
//       factory->AddSpectator("deltaMRel", "", "", 'F' );
...
//         factory->AddVariable("thetastarW1", "", "", 'F' );
//         factory->AddVariable("(thetastarW1 > 0)", "", "", 'F' );
//         factory->AddVariable("thetastarW1", "", "", 'I', -8, 8 );
...
//	TString fname_signal_test ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_0504_new_preselection_but_Mll/main_tmva_tree_VBF_HToMuMu_v25mu_QCDScalenom_JESnom.root";
//        TString fname_bg_test ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_0504_new_preselection_but_Mll/main_tmva_tree_DYJetsToLL_M-105To160-madgraphMLM_v25mu_QCDScalenom_JESnom.root";
//  

//    
//   TString fname_signal_train ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_0504_new_preselection_but_Mll/main_tmva_tree_VBF_HToMuMu_v25mu_QCDScalenom_JESnom.root";
//   TString fname_bg_train ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_0504_new_preselection_but_Mll/main_tmva_tree_DYJetsToLL_M-105To160-madgraphMLM_v25mu_QCDScalenom_JESnom.root" ;

   
   
//     TString fname_signal_test ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_new_preselection_but_Mll/main_tmva_tree_VBF_HToMuMu_v25mu_QCDScalenom_JESnom.root";
//     TString fname_bg_test ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_new_preselection_but_Mll/main_tmva_tree_DYJetsToLL_M-105To160-madgraphMLM_v25mu_QCDScalenom_JESnom.root";
//   
// 
//     
//    TString fname_signal_train ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_new_preselection_but_Mll/main_tmva_tree_VBF_HToMuMu_v25mu_QCDScalenom_JESnom.root";
//    TString fname_bg_train ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_new_preselection_but_Mll/main_tmva_tree_DYJetsToLL_M-105To160-madgraphMLM_v25mu_QCDScalenom_JESnom.root" ;
   
   

     TString fname_signal_test ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_new_preselection_trasformedVariables/main_tmva_tree_VBF_HToMuMu_v25mu_QCDScalenom_JESnom.root";
     TString fname_bg_test ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_new_preselection_trasformedVariables/main_tmva_tree_DYJetsToLL_M-105To160-madgraphMLM_v25mu_QCDScalenom_JESnom.root";
   
 
     
    TString fname_signal_train ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_new_preselection_trasformedVariables/main_tmva_tree_VBF_HToMuMu_v25mu_QCDScalenom_JESnom.root";
    TString fname_bg_train ="/scratch/mandorli/Hmumu/training/CMSSW_8_0_28/src/samples/sample_new_preselection_trasformedVariables/main_tmva_tree_DYJetsToLL_M-105To160-madgraphMLM_v25mu_QCDScalenom_JESnom.root" ;
 ...
 //TFile *input_signal_train = TFile::Open( fname_signal_train );//scommentate oggi 15dic2017
  //TFile *input_bg_train = TFile::Open( fname_bg_train );//scommentate oggi 15dic2017
   ...
   TTree *signal_test = (TTree*)input_signal_test->Get("TMVAtree");//scommentate oggi 15dic2017
   TTree *bg_test = (TTree*)input_bg_test->Get("TMVAtree");//scommentate oggi 15dic2017
...
//	factory->SetSignalWeightExpression("weightMVA");//scommentate oggi 15dic2017
   ...
   TCut mycuts = ""; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";        <----------------------------------------------------------------------------------------------- DA RIMETTERE
   TCut mycutb = ""; // for example: TCut mycutb = "abs(var1)<0.5";
/*   
   TCut mycuts = "!(abs(thetastarW1)>0.97 && abs(thetastarW1)<0.99)"; 
   TCut mycuts = "(abs(thetastarW1)<0.98996352 || abs(thetastarW1)>0.98996354) && abs(thetastarW1)<0.99"; */
//    TCut mycuts = "abs(thetastarW1)<0.99"; 
//    TCut mycutb = mycuts; 
...
//     SplitSeed++;
   ...
   int seddToUse = (SeedGen % 100)+1;
   sprintf(parameter_string,"SplitMode=Random:SplitSeed=%i:nTrain_Signal=180000:nTrain_Background=30000:NormMode=NumEvents:!V",seddToUse);    // I set the seed of the random choice equal to the number of variable
...
//       factory->BookMethod( TMVA::Types::kBDT, "BDTD",parString );
        }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (Use["PDERS"])
      factory->BookMethod( TMVA::Types::kPDERS, "PDERS",
                           "!H:!V:NormTree=T:VolumeRangeMode=RMS:KernelEstimator=Gauss:GaussSigma=0.3:NEventsMin=400:NEventsMax=600" );
...
//                            "!H:!V:NormTree=T:VolumeRangeMode=Adaptive:KernelEstimator=Gauss:GaussSigma=0.3:NEventsMin=400:NEventsMax=600" );
    ...
    if (Use["PDEFoam"])
      factory->BookMethod( TMVA::Types::kPDEFoam, "PDEFoam",
                           "!H:!V:SigBgSeparate=F:TailCut=0.001:VolFrac=0.15:nActiveCells=500:nSampl=2000:nBin=5:Nmin=100:Kernel=None:Compress=T" );
      

    // K-Nearest Neighbour classifier (KNN)
    if (Use["KNN"])
        factory->BookMethod( TMVA::Types::kKNN, "KNN",
//                            "H:nkNN=20:ScaleFrac=0.8:SigmaFact=1.0:Kernel=Gaus:UseKernel=F:UseWeight=T:!Trim" );      //DEFAULT
...
// TString variables_names_array_primary[primary_variables_number]={"MqqLog", "Rpt","W_mass_virtual1","ll_zstar", "qq_pt","softActivityEWK_njets5","W_mass_virtual2"} ;  // I used this the first time I trained without mass
// TString variables_names_array_primary[primary_variables_number]={"MqqLog", "Rpt","W_mass_virtual1","ll_zstar","softActivityEWK_njets5", "ll_pt","W_mass_virtual2"} ;
// TString variables_names_array_primary[primary_variables_number]={"ll_mass","MqqLog", "Rpt","ll_zstar","softActivityEWK_njets5", "ll_pt", "qgl_1qAtanh","W_mass_virtual1"} ;
TString variables_names_array_primary[primary_variables_number]={"ll_mass","MqqLog", "Rpt","W_mass_virtual1","ll_zstar","softActivityEWK_njets5", "ll_pt","W_mass_virtual2"} ;  // variabili aprile
//TString variables_names_array_primary[primary_variables_number]={"ll_mass","MqqLog", "Rpt","W_mass_virtual1Log","ll_zstar","softActivityEWK_njets5", "ll_pt","W_mass_virtual2Log"} ;  // variabili aprile
// TString variables_names_array_primary[primary_variables_number]={"ll_mass","MqqLog", "Rpt","W_mass_virtual1","ll_zstar","softActivityEWK_njets5", "ll_pt","W_mass_virtual2","qgl_1qAtanh"} ;  // variabili aprile
// TString variables_names_array_primary[primary_variables_number]={"ll_mass","Mqq", "Rpt","ll_zstar", "softActivityEWK_njets10", "ll_pt"} ;
...
// TString variables_names_array[max_variables_number]={"Invariant_MassLog","ll_mass","energytotLog","W_mass_virtual1","W_mass_virtual2","qgl_1qAtanh","qgl_2qAtanh" ,"thetastarW2","thetastarW1","theta1", "qq_pt","theta2","W_Pt_virtual1","W_Pt_virtual2","MqqLog", "Rpt", "ll_eta", "DeltaEtaQQ" ,"diffMassWWH", "ll_pt","Jet3_pt","ll_zstar","met_pt","softLeadingJet_pt","impulsoZ", "deltaMRel", "cosThetaPlane","softActivityEWK_njets5", "W_eta_virtual1","W_eta_virtual2","X_parton1","X_parton2", "mumujj_pt", "absCosThetaStarJet"};




const int max_variables_number=32;
TString variables_names_array[max_variables_number]={"Invariant_MassLog","energytotLog","W_mass_virtual1Log","W_mass_virtual2Log","qgl_1qAtanh","qgl_2qAtanh" ,"thetastarW2","thetastarW1","theta1", "qq_pt","theta2","W_Pt_virtual1","W_Pt_virtual2","MqqLog", "Rpt", "ll_eta", "DeltaEtaQQ" ,"diffMassWWH", "ll_pt","Jet3_pt","ll_zstar","met_pt","softLeadingJet_pt","impulsoZ"/*, "deltaMRel"*/, "cosThetaPlane","softActivityEWK_njets5", "W_eta_virtual1","W_eta_virtual2","X_parton1","X_parton2", "mumujj_pt", "absCosThetaStarJet"};
// TString variables_names_array[max_variables_number]={"Invariant_MassLog","energytotLog","W_mass_virtual1","W_mass_virtual2","qgl_1qAtanh","qgl_2qAtanh" ,"thetastarW2","thetastarW1","theta1", "qq_pt","theta2","W_Pt_virtual1","W_Pt_virtual2","MqqLog", "Rpt", "ll_eta", "DeltaEtaQQ" ,"diffMassWWH", "ll_pt","Jet3_pt","ll_zstar","met_pt","softLeadingJet_pt","impulsoZ"/*, "deltaMRel"*/, "cosThetaPlane","softActivityEWK_njets5", "W_eta_virtual1","W_eta_virtual2","X_parton1","X_parton2", "mumujj_pt", "absCosThetaStarJet"};




// const int max_variables_number=10;
// TString variables_names_array[max_variables_number]={"impulsoZ", "deltaMRel", "cosThetaPlane","softActivityEWK_njets5", "W_eta_virtual1","W_eta_virtual2","X_parton1","X_parton2", "mumujj_pt", "absCosThetaStarJet"};


//////////////////////////////////////////////// BEFORE NEW PRESELECTION ////////////////////////////////////////////////////////////////////////
// TString variables_names_array[max_variables_number]={"Inv_mass","ll_mass","energytotLog","W_mass_virtual1","W_mass_virtual2","qgl_1q","qgl_2q" ,"thetastarW2","thetastarW1","theta1", "qq_pt","theta2","W_Pt_virtual1","W_Pt_virtual2","Mqq", "Rpt", "ll_eta", "DeltaEtaQQ" ,"diffMassWWH", "ll_pt","Jet3_pt","ll_zstar","met_pt","softLeadingJet_pt","btagCMVA","impulsoZ", "deltaMRel", "cosThetaPlane","softActivityEWK_njets5", "W_eta_virtual1","W_eta_virtual2","E_parton1","E_parton2", "mumujj_pt", "cosThetaStarAbs", "absCosThetaStarJet"};
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

// const int max_variables_number=1;
// TString variables_names_array[max_variables_number]={"softActivityEWK_njets5"};

// const int max_variables_number=6;
// TString variables_names_array[max_variables_number]={"W_eta_virtual1","W_eta_virtual2","X_parton1","X_parton2", "mumujj_pt", "absCosThetaStarJet"};
